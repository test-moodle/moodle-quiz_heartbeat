...
/**
 * Behat quiz_heartbeat related steps definitions.
 *
...
/**
 * Behat step definitions for heartbeat quiz report plugin (quiz_heartbeat).
 *
 * @package   quiz_heartbeat
 * @copyright 2024 Philipp E. Imhof
 * @author    Philipp E. Imhof
 * @license   https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_quiz_heartbeat extends behat_question_base {

    /**
     * Convert page names to URLs for steps like 'When I am on the "[identifier]" "quiz_heartbeat > [page type]" page'.
     *
     * Recognised page names are:
     * | page type             | identifier meaning | description                                             |
     * | heartbeat report  | Quiz name          | Report for downloading essay responses and attachments  |
     *
    ...
    protected function resolve_page_instance_url(string $type, string $identifier): moodle_url {
        switch (strtolower($type)) {
            ...
            default:
                throw new Exception('Unrecognised quiz_heartbeat page type "' . $type . '".');
        }
    }
